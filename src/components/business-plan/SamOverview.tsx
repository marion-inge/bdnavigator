...
import { Plus, Trash2, Target, Building2, Users, MapPin, RefreshCw, Loader2, TrendingUp } from "lucide-react";
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="flex items-center gap-2"><TrendingUp className="h-4 w-4" /> {bp("Sales Channel Analysis", "Vertriebskanal-Analyse")}</CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <Label>{bp("Channel Strategy", "Kanalstrategie")}</Label>
