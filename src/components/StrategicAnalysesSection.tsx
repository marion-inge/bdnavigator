          ...
          <Card className="flex-1 flex flex-col">
            ...
            <CardContent className="space-y-6 flex-1 flex flex-col">
              ...
              <div className="space-y-3">
                <div><Label className="text-lg font-semibold">{t("saDescription")}</Label><Textarea className="min-h-[160px] text-lg leading-relaxed" value={is.ansoff.description} onChange={(e) => update({ ...data, ideaScoring: { ...is, ansoff: { ...is.ansoff, description: e.target.value } } })} placeholder={t("saDescPlaceholder")} disabled={readonly} /></div>
                <div><Label className="text-lg font-semibold">{t("saRationale")}</Label><Textarea className="min-h-[160px] text-lg leading-relaxed" value={is.ansoff.rationale} onChange={(e) => update({ ...data, ideaScoring: { ...is, ansoff: { ...is.ansoff, rationale: e.target.value } } })} placeholder={t("saRationalePlaceholder")} disabled={readonly} /></div>
              </div>
      ...
      <TabsContent value="bcg" className="flex-1 flex flex-col">
        <Card className="flex-1 flex flex-col">
          ...
          <CardContent className="space-y-6 flex-1 flex flex-col">
            ...
            <div className="space-y-3">
              <div><Label className="text-lg font-semibold">{t("saDescription")}</Label><Textarea className="min-h-[160px] text-lg leading-relaxed" value={is.bcg.description} onChange={(e) => update({ ...data, ideaScoring: { ...is, bcg: { ...is.bcg, description: e.target.value } } })} placeholder={t("saDescPlaceholder")} disabled={readonly} /></div>
              <div><Label className="text-lg font-semibold">{t("saRationale")}</Label><Textarea className="min-h-[160px] text-lg leading-relaxed" value={is.bcg.rationale} onChange={(e) => update({ ...data, ideaScoring: { ...is, bcg: { ...is.bcg, rationale: e.target.value } } })} placeholder={t("saRationalePlaceholder")} disabled={readonly} /></div>
            </div>
            {opportunityId && !readonly && (
              <IdaFrameworkButton
                opportunityId={opportunityId}
      ...
      <TabsContent value="mckinsey" className="flex-1 flex flex-col">
        <Card className="flex-1 flex flex-col">
          ...
          <CardContent className="space-y-6 flex-1 flex flex-col">
            ...
            <div className="space-y-3">
              <div><Label className="text-lg font-semibold">{t("saDescription")}</Label><Textarea className="min-h-[160px] text-lg leading-relaxed" value={is.mckinsey.description} onChange={(e) => update({ ...data, ideaScoring: { ...is, mckinsey: { ...is.mckinsey, description: e.target.value } } })} placeholder={t("saDescPlaceholder")} disabled={readonly} /></div>
              <div><Label className="text-lg font-semibold">{t("saRationale")}</Label><Textarea className="min-h-[160px] text-lg leading-relaxed" value={is.mckinsey.rationale} onChange={(e) => update({ ...data, ideaScoring: { ...is, mckinsey: { ...is.mckinsey, rationale: e.target.value } } })} placeholder={t("saRationalePlaceholder")} disabled={readonly} /></div>
            </div>
            {opportunityId && !readonly && (
              <IdaFrameworkButton
                opportunityId={opportunityId}
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <div className="space-y-3">
                    <div><Label className="text-lg font-semibold">{t("saDescription")}</Label><Textarea className="min-h-[160px] text-lg leading-relaxed" value={th.description} onChange={e => update({ ...data, ideaScoring: { ...is, threeHorizons: { ...th, description: e.target.value } } })} placeholder={t("saDescPlaceholder")} disabled={readonly} /></div>
                    <div><Label className="text-lg font-semibold">{t("saRationale")}</Label><Textarea className="min-h-[160px] text-lg leading-relaxed" value={th.rationale} onChange={e => update({ ...data, ideaScoring: { ...is, threeHorizons: { ...th, rationale: e.target.value } } })} placeholder={t("saRationalePlaceholder")} disabled={readonly} /></div>
                  </div>
                </>
              );
            })()}
