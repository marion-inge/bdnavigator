...
import { Plus, Trash2, Rocket, Handshake, Target } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="strategy" className="space-y-6">
        <TabsList className="flex-wrap h-auto gap-1 p-1">
          <TabsTrigger value="strategy" className="text-xs sm:text-sm gap-1">
            <Rocket className="h-3.5 w-3.5" /> {t("gtmStrategy")}
          </TabsTrigger>
          <TabsTrigger value="pilot" className="text-xs sm:text-sm gap-1">
            <Handshake className="h-3.5 w-3.5" /> {t("gtmPilotTitle" as any)}
          </TabsTrigger>
          <TabsTrigger value="leadgen" className="text-xs sm:text-sm gap-1">
            <Target className="h-3.5 w-3.5" /> {t("gtmLeadTitle" as any)}
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="strategy">
          <div className="space-y-6">
            {/* Structured Fields */}
            <Card>
              <CardHeader><CardTitle>{t("gtmStrategy")}</CardTitle></CardHeader>
