...
import { GoToMarketPlan, ChecklistItem, createDefaultGoToMarketPlan } from "@/lib/types";
...
export function GoToMarketSection({ goToMarketPlan, onSave, readonly }: Props) {
  ...
  const fields: { key: keyof GoToMarketPlan; label: string; placeholder: string; multiline?: boolean }[] = [
