...
import { calculateTotalScore, Stage, createDefaultBusinessPlan, createDefaultBusinessCase, STAGE_ORDER, BusinessPlanDatarom "@/lib/types";
...
type TabKey = "overview" | "scoring" | "sa_ansoff" | "sa_bcg" | "sa_mckinsey" | "sa_three_horizons" | "debubusiness_plansiness_case" | "implement_review" | "gates" | "strategic_analyses" | "files";
