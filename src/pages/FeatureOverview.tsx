...
const FEATURE_GROUPS: FeatureGroup[] = [
  {
    ...
    features: [
      { en: "Pipeline Funnel Visualization", de: "Pipeline-Trichter-Visualisierung", detail: "Interactive funnel chart showing idea distribution across stages", detailDe: "Interaktives Trichterdiagramm zur Verteilung der Ideas über Phasen" },
      ...
      { en: "Idea Table with Financial Metrics", de: "Idea-Tabelle mit Finanzkennzahlen", detail: "Columns for Stage, Industry, Owner, Scoring, TAM, SAM, SOM, Growth Rate, Payback", detailDe: "Spalten für Phase, Branche, Owner, Scoring, TAM, SAM, SOM, Wachstumsrate, Amortisationszeit" },
    ],
  },
  {
    titleEn: "Idea Management",
    titleDe: "Idea-Management",
    icon: <Lightbulb className="h-5 w-5" />,
    features: [
      { en: "Create New Ideas", de: "Neue Ideas anlegen", detail: "Dialog with fields for title, description, industry, geography, technology, owner", detailDe: "Dialog mit Feldern für Titel, Beschreibung, Branche, Geografie, Technologie, Owner" },
      { en: "Idea Detail View", de: "Idea-Detailansicht", detail: "Comprehensive view with tabs for all phases", detailDe: "Umfassende Ansicht mit Tabs für alle Phasen" },
      ...
      { en: "Editable Sections", de: "Bearbeitbare Sektionen", detail: "Inline editing for all idea fields", detailDe: "Inline-Bearbeitung aller Idea-Felder" },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { en: "Dashboard AI Recommendations", de: "Dashboard-KI-Empfehlungen", detail: "IDA's recommendations visible directly in the idea table", detailDe: "IDAs Empfehlungen direkt in der Idea-Tabelle sichtbar" },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { en: "PDF Export", de: "PDF-Export", detail: "Questionnaire and idea data export", detailDe: "Fragebogen- und Idea-Datenexport" },
