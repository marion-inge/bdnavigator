...
const STAGE_LABELS_EN: Record<string, string> = {
  ...
  gate2: "Gate 2",
  business_plan: "TAM SAM SOM Analysis",
  detailed_scoring: "TAM SAM SOM Analysis",
  gate3: "Gate 3",
  verify_market: "Market Verification",
  gate4: "Gate 4",
  investment_case: "Business Case",
  gate5: "Gate 5",
...
export async function exportOpportunityPdf(opp: Opportunity) {
  ...
  // Full business plan + business case + charts
  y += 4;
  y = await addBusinessPlanBody(doc, opp, y, false);
