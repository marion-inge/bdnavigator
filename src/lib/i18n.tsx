...
const translations = {
  en: {
    ...
    // Value Chain
    saValueChain: "Value Chain",
    saVcPrimary: "Primary Activities",
    saVcSupport: "Support Activities",
    saVcInboundLogistics: "Inbound Logistics",
    saVcOperations: "Operations",
    saVcOutboundLogistics: "Outbound Logistics",
    saVcMarketingSales: "Marketing & Sales",
    saVcService: "Service",
    saVcFirmInfrastructure: "Firm Infrastructure",
    saVcHrManagement: "HR Management",
    saVcTechnologyDev: "Technology Development",
    saVcProcurement: "Procurement",
    saVcRelevance: "Relevance",
    // Process Guide
  ...
  de: {
    ...
    // Value Chain
    saValueChain: "Wertschöpfungskette",
    saVcPrimary: "Primäre Aktivitäten",
    saVcSupport: "Unterstützungsaktivitäten",
    saVcInboundLogistics: "Eingangslogistik",
    saVcOperations: "Produktion",
    saVcOutboundLogistics: "Ausgangslogistik",
    saVcMarketingSales: "Marketing & Vertrieb",
    saVcService: "Kundendienst",
    saVcFirmInfrastructure: "Unternehmensinfrastruktur",
    saVcHrManagement: "Personalmanagement",
    saVcTechnologyDev: "Technologieentwicklung",
    saVcProcurement: "Beschaffung",
    saVcRelevance: "Relevanz",
    // Process Guide
