...
export const MOCK_OPPORTUNITIES: Opportunity[] = [
  {
    ...
    description: "Development of an AI-driven navigation assistance module targeting mid-size container vessels.",
    market: "Marine",
    owner: "Thomas Berger",
    stage: "business_case",
    ...
    detailedScoring: {
      marketAttractiveness: {
        score: 5,
        analysis: {
          tam: "€15B global autonomous shipping market by 2030",
          sam: "€3B European container fleet segment",
          targetCustomers: "Mid-size container operators (50-200 vessels)",
          customerRelationship: "Existing partnerships with 3 major operators",
          competitors: "Wärtsilä, Kongsberg, rolls-Royce Marine",
          competitivePosition: "Differentiated by AI-first approach and lower retrofit cost",
        },
      },
      strategicFit: { score: 4, details: "Core maritime digitalization strategy. Leverages existing sensor portfolio." },
      feasibility: { score: 3, details: "Sensor fusion expertise in-house. Classification society approval needed." },
      commercialViability: { score: 4, details: "SaaS + hardware model. €500K per vessel, 60% gross margin." },
      risk: { score: 2, details: "Regulatory risk manageable with classification society partnerships." },
    },
    businessCase: {
      ...
      paybackPeriod: 18,
      npv: 8500000,
      notes: "Based on 24 vessel installations in Year 1. Conservative TAM penetration of 2%.",
    },
    gates: [
      { id: "g-001a", gate: "gate1", decision: "go", comment: "Strong market pull confirmed. Proceed.", decider: "Dr. Claudia Weiss", date: "2025-11-15T10:00:00Z" },
      { id: "g-001b", gate: "gate2", decision: "go", comment: "Detail scoring approved. Excellent market analysis.", decider: "Michael Braun", date: "2026-01-10T14:00:00Z" },
    ],
  ...
  },
  {
    ...
    description: "Retrofit solution for diesel regional trains with hydrogen fuel cell powertrains.",
    market: "Hydrogen",
  ...
  },
  {
    ...
    description: "Cloud-based vibration analytics platform for offshore wind turbine gearboxes.",
    market: "Energy",
    owner: "Lisa Hoffmann",
    stage: "rough_scoring",
  ...
  },
  {
    ...
    description: "Acoustic modem for NATO-standard submarine communication.",
    market: "Defense",
    owner: "Stefan Koch",
    stage: "idea",
  ...
  },
  {
    ...
    description: "Autonomous baggage handling and pushback robots for airport ramp operations.",
    market: "Aviation",
    owner: "Anna Müller",
    stage: "go_to_market",
    ...
    gates: [
      { id: "g-005a", gate: "gate1", decision: "go", comment: "Excellent market fit. Fast-track.", decider: "Dr. Claudia Weiss", date: "2025-07-20T09:00:00Z" },
      { id: "g-005b", gate: "gate2", decision: "go", comment: "Detail scoring validated.", decider: "Michael Braun", date: "2025-10-10T14:00:00Z" },
      { id: "g-005c", gate: "gate3", decision: "go", comment: "Business case approved. Handing off to product management.", decider: "Dr. Claudia Weiss", date: "2025-12-10T14:00:00Z" },
    ],
  ...
  },
  {
    ...
    description: "Drone-based visual and thermal inspection service for railway infrastructure.",
    market: "Rail",
    owner: "Thomas Berger",
    stage: "closed",
    ...
    gates: [
      { id: "g-006", gate: "gate1", decision: "no-go", comment: "Insufficient strategic fit and market differentiation.", decider: "Michael Braun", date: "2026-01-25T16:00:00Z" },
    ],
  ...
  },
  {
    ...
    description: "Lightweight cobot solution for automated welding in confined ship compartments.",
    market: "Robotics",
    owner: "Lisa Hoffmann",
    ...
    gates: [
      { id: "g-007", gate: "gate1", decision: "go", comment: "Clear differentiation in a growing niche. Approved for detailed analysis.", decider: "Dr. Claudia Weiss", date: "2026-01-05T11:30:00Z" },
    ],
  ...
  },
  {
    ...
    description: "Software platform for optimizing battery storage dispatch in industrial microgrids.",
    market: "Energy",
    owner: "Markus Schneider",
    stage: "gate1",
