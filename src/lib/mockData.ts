...
export const MOCK_OPPORTUNITIES: Opportunity[] = [
  {
    ...
    detailedScoring: {
      ...
      commercialViability: { score: 4, details: "SaaS + hardware model. €500K per vessel installation + €50K/year software license. 60% gross margin at 20+ installations. Break-even at 15 vessels." },
  ...
  },
  {
    ...
    detailedScoring: {
      ...
      commercialViability: { score: 5, details: "RaaS model: €8K/robot/month (36-month contracts). COGS: €35K/robot. At 200 robots deployed: €19.2M ARR, 65% gross margin." },
  ...
  },
  {
    ...
    detailedScoring: {
      ...
      commercialViability: { score: 4, details: "System price: €150K. Gross margin: 55%. Recurring: €20K/year. Customer ROI: replaces 1.5 FTE welders — payback in 18 months." },
