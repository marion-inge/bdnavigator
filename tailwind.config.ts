  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        nogo: {
          DEFAULT: "hsl(var(--nogo))",
          foreground: "hsl(var(--nogo-foreground))",
        },
        sidebar: {
        ...
        stage: {
          ...
          "rough-scoring": "hsl(var(--stage-rough-scoring))",
          gate1: "hsl(var(--stage-gate1))",
          "detailed-scoring": "hsl(var(--stage-detailed-scoring))",
          gate2: "hsl(var(--stage-gate2))",
          "business-case": "hsl(var(--stage-business-case))",
          gate3: "hsl(var(--stage-gate3))",
          gate4: "hsl(var(--stage-gate4))",
          gate5: "hsl(var(--stage-gate5))",
          "market-intel": "hsl(var(--stage-market-intel))",
          "verify-market": "hsl(var(--stage-verify-market))",
